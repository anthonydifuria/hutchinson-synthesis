...
PERC_RANGE = (0.001, 0.2)
PERC_BIAS  = 1.0   # fallback without Voronoi
# Sampling freedom
FREEDOM_PERC           = 0.0
# Bias
# -1 = more percussive, +1 = more sustained
WEIGHT_PERC              = -1.0
FORCE_WEIGHT_PERC        = 1.0
